...
public class Client {
    ...
    public static void runAndListen() {
        ...
        buttonDownload.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (textFieldAddress.getText().equals("127.0.0.1:"+FtpPort) || textFieldAddress.getText().equals("localhost:"+FtpPort)) {
                    downloadFile();
                }
            }
        });
    ...
    public static void main(String[] args) {
        ...
        textFieldAddress = new JTextField("127.0.0.1:"+FtpPort);
